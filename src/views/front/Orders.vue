  ...
  <div>
    ...
    <el-table :data="tableData" stripe size="medium">
      ...
      <el-table-column label="操作" width="180" align="center">
        <template v-slot="scope">
          <el-button type="success" @click="changeStatus(scope.row, 1)" v-if="scope.row.status === 1">未发货</el-button>
          <el-button type="warning" @click="changeStatus(scope.row, 2)" v-if="scope.row.status === 2">确认收货</el-button>
          <el-button type="warning" @click="changeStatus(scope.row, 3)" v-if="scope.row.status === 3">未评论</el-button>
          <el-popconfirm
          ...
          >
            <el-button type="danger" slot="reference">退货</el-button>
          </el-popconfirm>
        </template>
      </el-table-column>
    </el-table>
